...
- Removed `@testing-library/jest-dom` (unused — vitest does not require it)
- Added `@testing-library/react` (React component tests)
- Added `jsdom` (DOM environment for component tests)
