...
- [ ] 25-02-terminology-server-proxy-PLAN.md — Add POST /api/terminology/lookup with SSRF guard + LRU cache + 503-when-disabled (TERM-03, TERM-05 partial; Wave 2, parallel-safe with 25-01)
